    ...
    return (
      <div className="col-md-12">
        <div className="card card-container">
          <img id="profile-img" className="profile-img-card" src="//ssl.gstatic.com/accounts/ui/avatar_2x.png" alt='home page' />
          {errorMessage &&
          ...
          <form name="form" onSubmit={(e) => this.handleRegister(e)}>
            ...
            <div className={'form-group' + (submitted && !user.role ? 'has-error' : '')}>
              ...
              <input type="text" className="form-control" name="role" value={user.role} onChange={(e) => this.handleChange(e)} />
              {submitted && !user.role &&
